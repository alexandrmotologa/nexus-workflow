...
Thank you for your interest in contributing to Nexus Workflow! We welcome contributions of all kinds, whether you are fixing a bug, improving documentation, or proposing new features.
...
1. **Fork the repository** and clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/nexus-workflow.git
   cd nexus-workflow
   ```
...
Nexus Workflow is built on **Java 21 LTS** using Apache Maven.
